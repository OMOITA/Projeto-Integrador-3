...
class APlicacaoCadastro(Funcoes_dos_bot, Relatorio):
    ...
    def _tela_(self):
        self.janela.title(
            "Bem-vindo ao nosso sistema de cadastro universitário")
    ...
    def _frame_da_tela(self):
        self.frame_1 = Frame(self.janela, bd=4, bg='#F5FFFA',
                             highlightbackground='#FFFACD', highlightthickness=3)
        self.frame_1.place(relx=0.02, rely=0.02, relheight=0.46, relwidth=0.96)

        self.frame_2 = Frame(self.janela, bd=4, bg='#F5FFFA',
                             highlightbackground='#FFFACD', highlightthickness=3)
    ...
    def _botton_da_tela_frame_01(self):
        # LIMPAR
        self.bt_limpar = Button(self.frame_1, text='LIMPAR', bd=2, font=(
            'verdana', 8, "bold"), command=self.limpar_tela_bt)
        self.bt_limpar.place(relx=0.2, rely=0.1,
                             relwidth=0.1, relheight=0.15, )
        # BUSCAR
        self.bt_buscar = Button(
            self.frame_1, text='BUSCAR', command=self.buscar_aluno)
        ...
        # APAGAR
        self.bt_apagar = Button(self.frame_1, text='APAGAR', bd=2, font=(
            'verdana', 8, 'bold'), command=self.apagar_cad)
    ...
    def lista_frame_02(self):
        # colunas
        self.lista_Aluno_Cads = ttk.Treeview(
            self.frame_2, height=3, columns=("RA", "Nome", "Curso", "E-mail"))
